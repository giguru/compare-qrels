...
used_set = sets['sample']
res = compute_qrels_df(qrels,
                       topics,
                       used_set[0],
                       used_set[1],
                       name_a="QuReTec (trained)",
                       name_b="Query Rewriting",
                       metrics={'recall.1000', 'recip_rank', 'map'})
res.print_analysis('recall_1000')
res.print_metric_hist('recall_1000')
res.print_delta_metric_hist('recall_1000')
res.print_delta_metric_box_plots('recall_1000')
